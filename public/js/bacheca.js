...
function onresult(json){
        if(json["success"]==true){//UPDATE AVVENUTO CON SUCCESSO
            ...
            h1_prezzo.textContent = (parseInt(h1_prezzo.textContent)+2).toString()+"€";
...
function onjson(json){
    ...
    for(let index=0; index< json.length;index++){
     ...
     //   icon1.src = "./image/offri.png";
        icon1.innerHTML="OFFRI";
        icon2.src="./image/follow.png";
        icon2.classList.add("bookmark");
      ...
      //  interaction_block.appendChild(icon2);
        article.appendChild(icon2)
        img_container.appendChild(img);
        seventy_block.appendChild(img_container)
        seventy_block.appendChild(icon1);
       // seventy_block.appendChild(interaction_block);
        
        
        title = document.createElement("p");
        title.classList.add("bold");
        title.textContent = element["plant_name"].split("(")[0];
        ...
        p1.classList.add("nullable");
        p2.classList.add("nullable");
        p3.classList.add("nullable");
        p4.classList.add("nullable");
...
function onoff_bookmark_handler(event){
    console.log( "SOA,P QIO");
    document.querySelector("#onoffbookmark_selectorimg").src = "./image/heart_"+(event.target.checked).toString()+".png";
